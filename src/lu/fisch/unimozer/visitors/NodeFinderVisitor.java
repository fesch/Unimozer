...
public final class NodeFinderVisitor implements VoidVisitor<Object> {
    ...
    public void visit(FieldDeclaration n, Object arg) {
        ...
        int pos = ((StringList) arg).toLinearPos(n.getBeginLine()-1,n.getBeginColumn()-1);
        
        String content = ((StringList) arg).copyFrom(n.getBeginLine()-1,
                                                           n.getBeginColumn()-1,
                                                           n.getEndLine()-1,
                                                           n.getEndColumn()-1);
    ...
    public void visit(ConstructorDeclaration n, Object arg) {
        ...
        printer.printLn("{");
        printer.indent();
        if(n.getData()==null) printer.printLn("");
        else if (((String) n.getData()).trim().equals("")) printer.printLn("");
        else printer.printLn((String) n.getData());
        printer.unindent();
        printer.print("}");
