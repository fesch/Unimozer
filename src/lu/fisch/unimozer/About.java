...
public class About extends JDialog implements ActionListener, KeyListener
{
	...
	public void create()
	{
			...
			//======== contentPanel ========
			{
				...
				//======== pnlTop ========
				{
					...
					//======== panel2 ========
					{
						...
						//---- lblVersion ----
						lblVersion.setText(Unimozer.E_VERSION);
						panel2.add(lblVersion, BorderLayout.CENTER);
					}
					pnlTop.add(panel2, BorderLayout.CENTER);
					
					//---- label2 ----
					label2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lu/fisch/icons/unimozer.png")));
		...
		txtThanks.setText(Unimozer.E_THANKS);
		...
		lblVersion.setText("Version "+Unimozer.E_VERSION);
	}
