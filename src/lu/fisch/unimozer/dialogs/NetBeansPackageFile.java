...
public class NetBeansPackageFile
{
     ...
     */
    NetBeansPackageFile(File dir)
    {
        this.dir = dir;
        this.pkgFile = new File(dir, Unimozer.N_PACKAGENAME);
    }

    @Override
    public String toString()
    {
        return "NetBeans package file in: " + dir.toString();
    }
    ...
    public static boolean exists(File dir)
    {
        ...
        File packageFile = new File(dir, Unimozer.N_PACKAGENAME);
    ...
    {
        return name.equals(Unimozer.N_PACKAGENAME);
    }
}
