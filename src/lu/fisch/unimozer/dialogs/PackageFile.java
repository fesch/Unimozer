...
public class PackageFile
{
    ...
    {
        this.dir = dir;
        this.pkgFile = new File(dir, Unimozer.U_PACKAGENAME);
    }

    @Override
    public String toString()
    {
        return "Unimozer package file in: " + dir.toString();
    }
    ...
    public static boolean exists(File dir)
    {
        ...
        File packageFile = new File(dir, Unimozer.U_PACKAGENAME);
    ...
    {
        return name.equals(Unimozer.U_PACKAGENAME);
    }
}
